...
Here's the cool part: we inherit all our mitochondria *only from our mothers*. Every mitochondrion in your body traces back through an unbroken maternal line — all the way to a single woman, scientists have nicknamed **"Mitochondrial Eve."** This makes these organelles even more exciting.
...
Fair question. [CRISPR](https://eli5sci.github.io/posts/doudna-2012/) is the "molecular scissors" everyone talks about, so why not just use it to fix the mutation?
...
In 2020, the [Liu Lab](https://www.liugroup.us/) at Harvard introduced a specialized editing system built specifically for the mitochondria: **DdCBEs** (DddA-derived cytosine base editors).
...
The tool is available at **[mitoedit.stjude.org](https://mitoedit.stjude.org/)**.
